...
from ..dataset.adult import adult_truncated
...
class adultController():
    ...
    def loadData(self):
        ...
        adult_train_ds = adult_truncated(parse=self.parse, transform=None)
        adult_test_ds = adult_truncated(parse=self.parse, transform=None)
