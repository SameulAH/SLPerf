...
from ..dataset.cheXpert import cheXpert_truncated
from ..partition.partitionFactory import partitionFactory
from core.log.Log import Log


class cheXpertController():
    ...
    def loadData(self):
        ...
        cheXpert_train_ds = cheXpert_truncated(parse=self.parse, transform=None)
        cheXpert_test_ds = cheXpert_truncated(parse=self.parse, train=False, transform=None)

        X_train, y_train = cheXpert_train_ds.data, cheXpert_train_ds.target
        X_test, y_test = cheXpert_test_ds.data, cheXpert_test_ds.target
