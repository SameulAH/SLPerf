    ...
    switch (op) {
            ...
            for (intptr_t i = 0; i < count; i++) {
                for (intptr_t j1 = 0; j1 < count1; j1++) {
                    for (intptr_t k1 = 0; k1 < array_of_blocklengths1[j1]; k1++) {
                        YAKSURI_SEQI_OP_LAND(*((const _Bool *) (const void *) (sbuf + i * extent + array_of_displs1[j1] + k1 * sizeof(_Bool))), *((_Bool *) (void *) (dbuf + idx)));
                        idx += sizeof(_Bool);
                    }
                }
            }
        ...
        case YAKSA_OP__LXOR:
        {
            for (intptr_t i = 0; i < count; i++) {
                for (intptr_t j1 = 0; j1 < count1; j1++) {
                    for (intptr_t k1 = 0; k1 < array_of_blocklengths1[j1]; k1++) {
                        YAKSURI_SEQI_OP_LXOR(*((const _Bool *) (const void *) (sbuf + i * extent + array_of_displs1[j1] + k1 * sizeof(_Bool))), *((_Bool *) (void *) (dbuf + idx)));
                        idx += sizeof(_Bool);
                    }
                }
            }
    ...
    switch (op) {
        case YAKSA_OP__LAND:
        {
            for (intptr_t i = 0; i < count; i++) {
                for (intptr_t j1 = 0; j1 < count1; j1++) {
                    for (intptr_t k1 = 0; k1 < array_of_blocklengths1[j1]; k1++) {
                        YAKSURI_SEQI_OP_LAND(*((const _Bool *) (const void *) (sbuf + idx)), *((_Bool *) (void *) (dbuf + i * extent + array_of_displs1[j1] + k1 * sizeof(_Bool))));
                        idx += sizeof(_Bool);
                    }
                }
            }
        ...
        case YAKSA_OP__LXOR:
        {
            for (intptr_t i = 0; i < count; i++) {
                for (intptr_t j1 = 0; j1 < count1; j1++) {
                    for (intptr_t k1 = 0; k1 < array_of_blocklengths1[j1]; k1++) {
                        YAKSURI_SEQI_OP_LXOR(*((const _Bool *) (const void *) (sbuf + idx)), *((_Bool *) (void *) (dbuf + i * extent + array_of_displs1[j1] + k1 * sizeof(_Bool))));
                        idx += sizeof(_Bool);
                    }
                }
            }
