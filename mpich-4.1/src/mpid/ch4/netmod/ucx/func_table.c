...
MPIDI_NM_funcs_t MPIDI_NM_ucx_funcs = {
    ...
    .mpi_win_create_dynamic_hook = MPIDI_UCX_mpi_win_create_dynamic_hook,
...
MPIDI_NM_native_funcs_t MPIDI_NM_native_ucx_funcs = {
    ...
    .mpi_win_set_info = MPIDI_UCX_mpi_win_set_info,
    ...
    .mpi_win_get_info = MPIDI_UCX_mpi_win_get_info,
    .mpi_get = MPIDI_NM_mpi_get,
    .mpi_win_free = MPIDI_UCX_mpi_win_free,
    .mpi_win_fence = MPIDI_NM_mpi_win_fence,
    .mpi_win_create = MPIDI_UCX_mpi_win_create,
    .mpi_accumulate = MPIDI_NM_mpi_accumulate,
    .mpi_win_attach = MPIDI_UCX_mpi_win_attach,
    .mpi_win_allocate_shared = MPIDI_UCX_mpi_win_allocate_shared,
    .mpi_rput = MPIDI_NM_mpi_rput,
    .mpi_win_flush_local = MPIDI_NM_mpi_win_flush_local,
    .mpi_win_detach = MPIDI_UCX_mpi_win_detach,
    ...
    .mpi_win_allocate = MPIDI_UCX_mpi_win_allocate,
    ...
    .mpi_win_create_dynamic = MPIDI_UCX_mpi_win_create_dynamic,
