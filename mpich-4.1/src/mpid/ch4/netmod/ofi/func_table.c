...
MPIDI_NM_funcs_t MPIDI_NM_ofi_funcs = {
    ...
    .upids_to_gpids = MPIDI_OFI_upids_to_gpids,
    .dynamic_send = MPIDI_OFI_dynamic_send,
    .dynamic_recv = MPIDI_OFI_dynamic_recv,
    ...
    .mpi_win_allocate_hook = MPIDI_OFI_mpi_win_allocate_hook,
    .mpi_win_allocate_shared_hook = MPIDI_OFI_mpi_win_allocate_shared_hook,
    .mpi_win_create_dynamic_hook = MPIDI_OFI_mpi_win_create_dynamic_hook,
    .mpi_win_attach_hook = MPIDI_OFI_mpi_win_attach_hook,
    .mpi_win_detach_hook = MPIDI_OFI_mpi_win_detach_hook,
    .mpi_win_free_hook = MPIDI_OFI_mpi_win_free_hook,
...
MPIDI_NM_native_funcs_t MPIDI_NM_native_ofi_funcs = {
    ...
    .mpi_psend_init = MPIDI_OFI_mpi_psend_init,
    .mpi_precv_init = MPIDI_OFI_mpi_precv_init,
    ...
    .mpi_free_mem = MPIDI_OFI_mpi_free_mem,
    .mpi_improbe = MPIDI_NM_mpi_improbe,
    .mpi_iprobe = MPIDI_NM_mpi_iprobe,
    .mpi_win_set_info = MPIDI_OFI_mpi_win_set_info,
    ...
    .mpi_win_get_info = MPIDI_OFI_mpi_win_get_info,
    .mpi_get = MPIDI_NM_mpi_get,
    .mpi_win_free = MPIDI_OFI_mpi_win_free,
    .mpi_win_fence = MPIDI_NM_mpi_win_fence,
    .mpi_win_create = MPIDI_OFI_mpi_win_create,
    .mpi_accumulate = MPIDI_NM_mpi_accumulate,
    .mpi_win_attach = MPIDI_OFI_mpi_win_attach,
    .mpi_win_allocate_shared = MPIDI_OFI_mpi_win_allocate_shared,
    .mpi_rput = MPIDI_NM_mpi_rput,
    .mpi_win_flush_local = MPIDI_NM_mpi_win_flush_local,
    .mpi_win_detach = MPIDI_OFI_mpi_win_detach,
    ...
    .mpi_win_allocate = MPIDI_OFI_mpi_win_allocate,
    ...
    .mpi_win_create_dynamic = MPIDI_OFI_mpi_win_create_dynamic,
    ...
    .mpi_type_commit_hook = MPIDI_OFI_mpi_type_commit_hook,
    .mpi_type_free_hook = MPIDI_OFI_mpi_type_free_hook,
    .mpi_op_commit_hook = MPIDI_OFI_mpi_op_commit_hook,
    .mpi_op_free_hook = MPIDI_OFI_mpi_op_free_hook,
};
#endif
