...
static inline int MPII_qmpi_register_internal_functions(void)
{
    ...
    MPIR_QMPI_pointers[MPIX_DELETE_ERROR_CLASS_T] = (void (*)(void)) &QMPIX_Delete_error_class;
    MPIR_QMPI_pointers[MPIX_DELETE_ERROR_CODE_T] = (void (*)(void)) &QMPIX_Delete_error_code;
    MPIR_QMPI_pointers[MPIX_DELETE_ERROR_STRING_T] = (void (*)(void)) &QMPIX_Delete_error_string;
