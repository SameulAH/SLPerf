...
{
    return internal_Ialltoall(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm, request);
}
#endif /* MPICH_MPI_FROM_PMPI */
int MPI_Ialltoall(const void *sendbuf, int sendcount, MPI_Datatype sendtype, void *recvbuf,
                  int recvcount, MPI_Datatype recvtype, MPI_Comm comm, MPI_Request *request)
{
    ...
    QMPI_Ialltoall_t *fn_ptr;

    context.storage_stack = NULL;

    if (MPIR_QMPI_num_tools == 0)
        return QMPI_Ialltoall(context, 0, sendbuf, sendcount, sendtype, recvbuf, recvcount,
                              recvtype, comm, request);

    fn_ptr = (QMPI_Ialltoall_t *) MPIR_QMPI_first_fn_ptrs[MPI_IALLTOALL_T];

    return (*fn_ptr) (context, MPIR_QMPI_first_tool_ids[MPI_IALLTOALL_T], sendbuf, sendcount,
...
int MPI_Ialltoall_c(const void *sendbuf, MPI_Count sendcount, MPI_Datatype sendtype, void *recvbuf,
                    ...
                    MPI_Request *request)  __attribute__ ((weak, alias("PMPI_Ialltoall_c")));
#endif
/* -- End Profiling Symbol Block */
...
{
    return internal_Ialltoall_c(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm, request);
}
#endif /* MPICH_MPI_FROM_PMPI */
int MPI_Ialltoall_c(const void *sendbuf, MPI_Count sendcount, MPI_Datatype sendtype, void *recvbuf,
                    MPI_Count recvcount, MPI_Datatype recvtype, MPI_Comm comm,
...
{
    QMPI_Context context;
    QMPI_Ialltoall_c_t *fn_ptr;

    context.storage_stack = NULL;

    if (MPIR_QMPI_num_tools == 0)
        return QMPI_Ialltoall_c(context, 0, sendbuf, sendcount, sendtype, recvbuf, recvcount,
                                recvtype, comm, request);

    fn_ptr = (QMPI_Ialltoall_c_t *) MPIR_QMPI_first_fn_ptrs[MPI_IALLTOALL_C_T];

    return (*fn_ptr) (context, MPIR_QMPI_first_tool_ids[MPI_IALLTOALL_C_T], sendbuf, sendcount,
            sendtype, recvbuf, recvcount, recvtype, comm, request);
}
#else /* ENABLE_QMPI */
