...
int QMPI_Alltoallw_init(QMPI_Context context, int tool_id, const void *sendbuf,
                        ...
                        MPI_Request *request)
{
    return internal_Alltoallw_init(sendbuf, sendcounts, sdispls, sendtypes, recvbuf, recvcounts, rdispls, recvtypes, comm, info, request);
}
#endif /* MPICH_MPI_FROM_PMPI */
int MPI_Alltoallw_init(const void *sendbuf, const int sendcounts[], const int sdispls[],
                       const MPI_Datatype sendtypes[], void *recvbuf, const int recvcounts[],
                       ...
                       MPI_Info info, MPI_Request *request)
{
    ...
    QMPI_Alltoallw_init_t *fn_ptr;

    context.storage_stack = NULL;

    if (MPIR_QMPI_num_tools == 0)
        return QMPI_Alltoallw_init(context, 0, sendbuf, sendcounts, sdispls, sendtypes, recvbuf,
                                   recvcounts, rdispls, recvtypes, comm, info, request);

    fn_ptr = (QMPI_Alltoallw_init_t *) MPIR_QMPI_first_fn_ptrs[MPI_ALLTOALLW_INIT_T];

    return (*fn_ptr) (context, MPIR_QMPI_first_tool_ids[MPI_ALLTOALLW_INIT_T], sendbuf, sendcounts,
            sdispls, sendtypes, recvbuf, recvcounts, rdispls, recvtypes, comm, info, request);
}
#else /* ENABLE_QMPI */
...
int QMPI_Alltoallw_init_c(QMPI_Context context, int tool_id, const void *sendbuf,
                          ...
                          MPI_Request *request)
{
    return internal_Alltoallw_init_c(sendbuf, sendcounts, sdispls, sendtypes, recvbuf, recvcounts, rdispls, recvtypes, comm, info, request);
}
#endif /* MPICH_MPI_FROM_PMPI */
int MPI_Alltoallw_init_c(const void *sendbuf, const MPI_Count sendcounts[],
                         const MPI_Aint sdispls[], const MPI_Datatype sendtypes[], void *recvbuf,
...
{
    QMPI_Context context;
    QMPI_Alltoallw_init_c_t *fn_ptr;

    context.storage_stack = NULL;

    if (MPIR_QMPI_num_tools == 0)
        return QMPI_Alltoallw_init_c(context, 0, sendbuf, sendcounts, sdispls, sendtypes, recvbuf,
                                     recvcounts, rdispls, recvtypes, comm, info, request);

    fn_ptr = (QMPI_Alltoallw_init_c_t *) MPIR_QMPI_first_fn_ptrs[MPI_ALLTOALLW_INIT_C_T];

    return (*fn_ptr) (context, MPIR_QMPI_first_tool_ids[MPI_ALLTOALLW_INIT_C_T], sendbuf,
