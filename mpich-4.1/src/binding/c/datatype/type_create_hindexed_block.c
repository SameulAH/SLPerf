...
int QMPI_Type_create_hindexed_block(QMPI_Context context, int tool_id, int count, int blocklength,
                                    ...
                                    MPI_Datatype *newtype)
{
    return internal_Type_create_hindexed_block(count, blocklength, array_of_displacements, oldtype, newtype);
}
#endif /* MPICH_MPI_FROM_PMPI */
int MPI_Type_create_hindexed_block(int count, int blocklength,
                                   const MPI_Aint array_of_displacements[], MPI_Datatype oldtype,
                                   MPI_Datatype *newtype)
{
    ...
    QMPI_Type_create_hindexed_block_t *fn_ptr;

    context.storage_stack = NULL;

    if (MPIR_QMPI_num_tools == 0)
        return QMPI_Type_create_hindexed_block(context, 0, count, blocklength,
                                               array_of_displacements, oldtype, newtype);

    fn_ptr = (QMPI_Type_create_hindexed_block_t *) MPIR_QMPI_first_fn_ptrs[MPI_TYPE_CREATE_HINDEXED_BLOCK_T];

    return (*fn_ptr) (context, MPIR_QMPI_first_tool_ids[MPI_TYPE_CREATE_HINDEXED_BLOCK_T], count,
            blocklength, array_of_displacements, oldtype, newtype);
}
#else /* ENABLE_QMPI */
...
int QMPI_Type_create_hindexed_block_c(QMPI_Context context, int tool_id, MPI_Count count,
                                      ...
                                      MPI_Datatype oldtype, MPI_Datatype *newtype)
{
    return internal_Type_create_hindexed_block_c(count, blocklength, array_of_displacements, oldtype, newtype);
}
#endif /* MPICH_MPI_FROM_PMPI */
int MPI_Type_create_hindexed_block_c(MPI_Count count, MPI_Count blocklength,
                                     const MPI_Count array_of_displacements[], MPI_Datatype oldtype,
...
{
    QMPI_Context context;
    QMPI_Type_create_hindexed_block_c_t *fn_ptr;

    context.storage_stack = NULL;

    if (MPIR_QMPI_num_tools == 0)
        return QMPI_Type_create_hindexed_block_c(context, 0, count, blocklength,
                                                 array_of_displacements, oldtype, newtype);

    fn_ptr = (QMPI_Type_create_hindexed_block_c_t *) MPIR_QMPI_first_fn_ptrs[MPI_TYPE_CREATE_HINDEXED_BLOCK_C_T];

    return (*fn_ptr) (context, MPIR_QMPI_first_tool_ids[MPI_TYPE_CREATE_HINDEXED_BLOCK_C_T], count,
            blocklength, array_of_displacements, oldtype, newtype);
}
#else /* ENABLE_QMPI */
