...
integer, parameter :: MPI_MAX_PROCESSOR_NAME           = 128
...
! Datatypes
type(MPI_Datatype), parameter   :: MPI_COMPLEX         = MPI_Datatype(MPI_DATATYPE_NULL%MPI_VAL)
type(MPI_Datatype), parameter   :: MPI_DOUBLE_COMPLEX  = MPI_Datatype(MPI_DATATYPE_NULL%MPI_VAL)
type(MPI_Datatype), parameter   :: MPI_LOGICAL         = MPI_Datatype(MPI_DATATYPE_NULL%MPI_VAL)
type(MPI_Datatype), parameter   :: MPI_REAL            = MPI_Datatype(MPI_DATATYPE_NULL%MPI_VAL)
type(MPI_Datatype), parameter   :: MPI_DOUBLE_PRECISION = MPI_Datatype(MPI_DATATYPE_NULL%MPI_VAL)
type(MPI_Datatype), parameter   :: MPI_INTEGER         = MPI_Datatype(MPI_DATATYPE_NULL%MPI_VAL)
type(MPI_Datatype), parameter   :: MPI_2INTEGER        = MPI_Datatype(MPI_DATATYPE_NULL%MPI_VAL)
type(MPI_Datatype), parameter   :: MPI_2DOUBLE_PRECISION = MPI_Datatype(MPI_DATATYPE_NULL%MPI_VAL)
type(MPI_Datatype), parameter   :: MPI_2REAL           = MPI_Datatype(MPI_DATATYPE_NULL%MPI_VAL)
type(MPI_Datatype), parameter   :: MPI_CHARACTER       = MPI_Datatype(MPI_DATATYPE_NULL%MPI_VAL)
...
type(MPI_Datatype), parameter   :: MPI_INTEGER1        = MPI_Datatype(MPI_DATATYPE_NULL%MPI_VAL)
type(MPI_Datatype), parameter   :: MPI_INTEGER2        = MPI_Datatype(MPI_DATATYPE_NULL%MPI_VAL)
type(MPI_Datatype), parameter   :: MPI_INTEGER4        = MPI_Datatype(MPI_DATATYPE_NULL%MPI_VAL)
type(MPI_Datatype), parameter   :: MPI_INTEGER8        = MPI_Datatype(MPI_DATATYPE_NULL%MPI_VAL)
type(MPI_Datatype), parameter   :: MPI_INTEGER16       = MPI_Datatype(MPI_DATATYPE_NULL%MPI_VAL)
type(MPI_Datatype), parameter   :: MPI_REAL4           = MPI_Datatype(MPI_DATATYPE_NULL%MPI_VAL)
type(MPI_Datatype), parameter   :: MPI_REAL8           = MPI_Datatype(MPI_DATATYPE_NULL%MPI_VAL)
type(MPI_Datatype), parameter   :: MPI_REAL16          = MPI_Datatype(MPI_DATATYPE_NULL%MPI_VAL)
type(MPI_Datatype), parameter   :: MPI_COMPLEX8        = MPI_Datatype(MPI_DATATYPE_NULL%MPI_VAL)
type(MPI_Datatype), parameter   :: MPI_COMPLEX16       = MPI_Datatype(MPI_DATATYPE_NULL%MPI_VAL)
type(MPI_Datatype), parameter   :: MPI_COMPLEX32       = MPI_Datatype(MPI_DATATYPE_NULL%MPI_VAL)
type(MPI_Datatype), parameter   :: MPI_CHAR            = MPI_Datatype(1275068673)
type(MPI_Datatype), parameter   :: MPI_SIGNED_CHAR     = MPI_Datatype(1275068696)
type(MPI_Datatype), parameter   :: MPI_UNSIGNED_CHAR   = MPI_Datatype(1275068674)
type(MPI_Datatype), parameter   :: MPI_WCHAR           = MPI_Datatype(1275069454)
type(MPI_Datatype), parameter   :: MPI_SHORT           = MPI_Datatype(1275068931)
type(MPI_Datatype), parameter   :: MPI_UNSIGNED_SHORT  = MPI_Datatype(1275068932)
type(MPI_Datatype), parameter   :: MPI_INT             = MPI_Datatype(1275069445)
type(MPI_Datatype), parameter   :: MPI_UNSIGNED        = MPI_Datatype(1275069446)
type(MPI_Datatype), parameter   :: MPI_LONG            = MPI_Datatype(1275070471)
type(MPI_Datatype), parameter   :: MPI_UNSIGNED_LONG   = MPI_Datatype(1275070472)
type(MPI_Datatype), parameter   :: MPI_FLOAT           = MPI_Datatype(1275069450)
type(MPI_Datatype), parameter   :: MPI_DOUBLE          = MPI_Datatype(1275070475)
type(MPI_Datatype), parameter   :: MPI_LONG_DOUBLE     = MPI_Datatype(1275072524)
type(MPI_Datatype), parameter   :: MPI_LONG_LONG_INT   = MPI_Datatype(1275070473)
type(MPI_Datatype), parameter   :: MPI_UNSIGNED_LONG_LONG = MPI_Datatype(1275070489)
type(MPI_Datatype), parameter   :: MPI_LONG_LONG       = MPI_Datatype(1275070473)
type(MPI_Datatype), parameter   :: MPI_FLOAT_INT       = MPI_Datatype(-1946157056)
type(MPI_Datatype), parameter   :: MPI_DOUBLE_INT      = MPI_Datatype(-1946157055)
type(MPI_Datatype), parameter   :: MPI_LONG_INT        = MPI_Datatype(-1946157054)
type(MPI_Datatype), parameter   :: MPI_SHORT_INT       = MPI_Datatype(-1946157053)
type(MPI_Datatype), parameter   :: MPI_2INT            = MPI_Datatype(1275070486)
type(MPI_Datatype), parameter   :: MPI_LONG_DOUBLE_INT = MPI_Datatype(-1946157052)
type(MPI_Datatype), parameter   :: MPI_INT8_T          = MPI_Datatype(1275068727)
type(MPI_Datatype), parameter   :: MPI_INT16_T         = MPI_Datatype(1275068984)
type(MPI_Datatype), parameter   :: MPI_INT32_T         = MPI_Datatype(1275069497)
type(MPI_Datatype), parameter   :: MPI_INT64_T         = MPI_Datatype(1275070522)
type(MPI_Datatype), parameter   :: MPI_UINT8_T         = MPI_Datatype(1275068731)
type(MPI_Datatype), parameter   :: MPI_UINT16_T        = MPI_Datatype(1275068988)
type(MPI_Datatype), parameter   :: MPI_UINT32_T        = MPI_Datatype(1275069501)
type(MPI_Datatype), parameter   :: MPI_UINT64_T        = MPI_Datatype(1275070526)
type(MPI_Datatype), parameter   :: MPI_C_BOOL          = MPI_Datatype(1275068735)
type(MPI_Datatype), parameter   :: MPI_C_FLOAT_COMPLEX = MPI_Datatype(1275070528)
type(MPI_Datatype), parameter   :: MPI_C_COMPLEX       = MPI_Datatype(1275070528)
type(MPI_Datatype), parameter   :: MPI_C_DOUBLE_COMPLEX = MPI_Datatype(1275072577)
type(MPI_Datatype), parameter   :: MPI_C_LONG_DOUBLE_COMPLEX = MPI_Datatype(1275076674)
type(MPI_Datatype), parameter   :: MPI_AINT            = MPI_Datatype(1275070531)
type(MPI_Datatype), parameter   :: MPI_OFFSET          = MPI_Datatype(1275070532)
type(MPI_Datatype), parameter   :: MPI_COUNT           = MPI_Datatype(1275070533)
type(MPI_Datatype), parameter   :: MPI_CXX_BOOL        = MPI_Datatype(1275068723)
type(MPI_Datatype), parameter   :: MPI_CXX_FLOAT_COMPLEX = MPI_Datatype(1275070516)
type(MPI_Datatype), parameter   :: MPI_CXX_DOUBLE_COMPLEX = MPI_Datatype(1275072565)
type(MPI_Datatype), parameter   :: MPI_CXX_LONG_DOUBLE_COMPLEX = MPI_Datatype(1275076662)
