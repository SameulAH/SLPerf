...
C      
       ...
       INTEGER MPI_COMPLEX
       PARAMETER (MPI_COMPLEX=MPI_DATATYPE_NULL)
       INTEGER MPI_DOUBLE_COMPLEX
       PARAMETER (MPI_DOUBLE_COMPLEX=MPI_DATATYPE_NULL)
       INTEGER MPI_LOGICAL
       PARAMETER (MPI_LOGICAL=MPI_DATATYPE_NULL)
       INTEGER MPI_REAL
       PARAMETER (MPI_REAL=MPI_DATATYPE_NULL)
       INTEGER MPI_DOUBLE_PRECISION
       PARAMETER (MPI_DOUBLE_PRECISION=MPI_DATATYPE_NULL)
       INTEGER MPI_INTEGER
       PARAMETER (MPI_INTEGER=MPI_DATATYPE_NULL)
       INTEGER MPI_2INTEGER
       PARAMETER (MPI_2INTEGER=MPI_DATATYPE_NULL)
       INTEGER MPI_2DOUBLE_PRECISION
       PARAMETER (MPI_2DOUBLE_PRECISION=MPI_DATATYPE_NULL)
       INTEGER MPI_2REAL
       PARAMETER (MPI_2REAL=MPI_DATATYPE_NULL)
       INTEGER MPI_CHARACTER
       PARAMETER (MPI_CHARACTER=MPI_DATATYPE_NULL)
       INTEGER MPI_BYTE
       ...
       PARAMETER (MPI_INTEGER2=MPI_DATATYPE_NULL)
       INTEGER MPI_INTEGER4
       PARAMETER (MPI_INTEGER4=MPI_DATATYPE_NULL)
       INTEGER MPI_INTEGER8
       PARAMETER (MPI_INTEGER8=MPI_DATATYPE_NULL)
       INTEGER MPI_INTEGER16
       PARAMETER (MPI_INTEGER16=MPI_DATATYPE_NULL)
       INTEGER MPI_REAL4
       PARAMETER (MPI_REAL4=MPI_DATATYPE_NULL)
       INTEGER MPI_REAL8
       PARAMETER (MPI_REAL8=MPI_DATATYPE_NULL)
       INTEGER MPI_REAL16
       PARAMETER (MPI_REAL16=MPI_DATATYPE_NULL)
       INTEGER MPI_COMPLEX8
       PARAMETER (MPI_COMPLEX8=MPI_DATATYPE_NULL)
       INTEGER MPI_COMPLEX16
       PARAMETER (MPI_COMPLEX16=MPI_DATATYPE_NULL)
       ...
       PARAMETER (MPI_COUNT_KIND=)
       INTEGER MPI_INTEGER_KIND
       PARAMETER (MPI_INTEGER_KIND=)
       INTEGER MPI_CHAR
       ...
       INTEGER MPI_BOTTOM, MPI_IN_PLACE, MPI_UNWEIGHTED(1)
