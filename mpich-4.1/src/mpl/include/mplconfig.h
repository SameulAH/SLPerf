...
#ifndef MPL_HAVE_CPU_SET_MACROS
#define MPL_HAVE_CPU_SET_MACROS 1
#endif

/* Define if cpu_set_t is defined in sched.h */
#ifndef MPL_HAVE_CPU_SET_T
#define MPL_HAVE_CPU_SET_T 1
#endif
...
#ifndef MPL_HAVE_LIBCUDA
#define MPL_HAVE_LIBCUDA 1
#endif

/* Define to 1 if you have the `dl' library (-ldl). */
#ifndef MPL_HAVE_LIBDL
#define MPL_HAVE_LIBDL 1
#endif
...
#ifndef MPL_HAVE_MISC_GETNPROCS
#define MPL_HAVE_MISC_GETNPROCS 1
#endif
...
#ifndef MPL_HAVE_PTHREAD_SETAFFINITY_NP
#define MPL_HAVE_PTHREAD_SETAFFINITY_NP 1
#endif

/* Define to 1 if you have the `pthread_yield' function. */
/* #undef MPL_HAVE_PTHREAD_YIELD */
...
#ifndef MPL_HAVE_SCHED_GETAFFINITY
#define MPL_HAVE_SCHED_GETAFFINITY 1
#endif
...
#ifndef MPL_HAVE_SCHED_SETAFFINITY
#define MPL_HAVE_SCHED_SETAFFINITY 1
#endif
...
/* #undef MPL_HAVE_THREAD_POLICY_SET */
...
/* #undef MPL_HAVE_VALGRIND_DRD_H */

/* Define to 1 if you have the <valgrind.h> header file. */
/* #undef MPL_HAVE_VALGRIND_H */

/* Define to 1 if you have the <valgrind/helgrind.h> header file. */
/* #undef MPL_HAVE_VALGRIND_HELGRIND_H */

/* Define to 1 if you have the <valgrind/memcheck.h> header file. */
/* #undef MPL_HAVE_VALGRIND_MEMCHECK_H */

/* Define to 1 if you have the <valgrind/valgrind.h> header file. */
/* #undef MPL_HAVE_VALGRIND_VALGRIND_H */
